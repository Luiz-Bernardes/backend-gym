class TrainingsController < ApplicationController
  ...
  # PATCH/PUT /records/:record_id/trainings/1
  def update
  ...
  # DELETE /records/:record_id/trainings/1
  def destroy
    @training.destroy
  end
